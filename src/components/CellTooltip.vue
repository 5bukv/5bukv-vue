...
<template>
  <div
    ...
    "
    class="absolute top-[calc(100%+15px)] z-20 h-auto rounded-lg bg-white p-2.5 text-center text-[13px] font-normal text-[#202020] duration-300 ease-[cubic-bezier(0.4,0.1,0.2,1)] before:absolute before:top-0 before:inline-block before:-translate-x-2/4 before:-translate-y-6 before:border-[12px] before:border-solid before:border-transparent before:border-b-[white] before:content-['']"
  >
